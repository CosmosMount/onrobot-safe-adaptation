"""Isaac Lab scene configuration, imported after AppLauncher."""
...
class PhysicsIntervalImu(Imu):
    """Update acceleration at the shared 2 ms physics-frame cadence."""
...
# Compatibility name for downstream imports; the configured sensor now runs at
# physics cadence rather than policy cadence.
PolicyIntervalImu = PhysicsIntervalImu
...
class Go2SQRLIsaacEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.init_state.rot = DEFAULT_BASE_QUATERNION_WXYZ
        ...
        self.scene.height_scanner.update_period = PHYSICS_DT
